      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="mt-8 space-y-3">
          ...
          <button
            ...
            className="w-full bg-white border border-gray-300 text-gray-700 py-4 rounded-2xl font-medium flex items-center justify-center space-x-3 hover:bg-gray-50 transition-colors disabled:opacity-50 shadow-sm"
          >
            ...
            <span>{isGoogleLoading ? '구글 로그인 중...' : '구글로 로그인'}</span>
          </button>
