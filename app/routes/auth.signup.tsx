...
export default function Signup() {
  ...
  const handleGoogleLogin = async () => {
    if (isGoogleLoading) return // 중복 클릭 방지
    
    setIsGoogleLoading(true)
    try {
      // 클라이언트에서 직접 구글 OAuth 처리
      const supabase = createSupabaseClient()
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 space-y-3">
              ...
              <button
                ...
                className="w-full inline-flex justify-center py-3 px-4 border border-gray-300 rounded-xl shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 disabled:opacity-50 transition-all"
              >
                ...
                {isGoogleLoading ? '구글로 시작하는 중...' : '구글로 시작하기'}
              </button>
